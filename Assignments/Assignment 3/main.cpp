...
int main() {
  ...
  int t;
  cin >> t;
  double setduration = 0, getduration = 0, orduration = 0, andduration = 0,
         complementduration = 0, resizeduration = 0, extractduration = 0;
  while (t--) {
    char c;
    cin >> c;
    switch (c) {
    case 'S': {
      ...
      setduration +=
          chrono::duration_cast<std::chrono::microseconds>(t2 - t1).count();
      break;
    }
    case 'G': {
      int x, y, id;
